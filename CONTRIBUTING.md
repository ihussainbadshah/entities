...
`eclipse-ecsp/entities` up to date and always improving! There are a few guidelines that we need
contributors to follow to keep the project consistent, as well as allow us to keep
maintaining `eclipse-ecsp/entities` in a reasonable amount of time.
...
- Submit a pull request from your topic branch to the [main](https://github.com/eclipse-ecsp/entities) branch on the `eclipse-ecsp/entities` repository.
...
- Ensure that the PR is tagged with related [issue](https://github.com/eclipse-ecsp/entities/issues) it intends to resolve.
